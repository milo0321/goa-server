...
pub async fn list_accounts(
    ...
    let response = repository::list_accounts(State(state), params).await?;
    Ok(response)
}
...
pub async fn get_account(
    ...
    let response = repository::get_account(State(state), Path(id)).await?;
    Ok(response)
}
...
pub async fn create_account(
    ...
    let response: EmailAccount = repository::create_account(State(state), params).await?;
    Ok(response)
}
...
pub async fn update_account(
    ...
    let response = repository::update_account(State(state), Path(id), params).await?;
    Ok(response)
}
...
pub async fn delete_account(
    ...
    repository::delete_account(State(state), Path(id)).await?;
...
pub async fn list_messages(
    ...
    let response = repository::list_messages(State(state), params).await?;
    Ok(response)
}
...
pub async fn get_message(
    ...
    let response = repository::get_message(State(state), Path(id)).await?;
    Ok(response)
}
...
pub async fn create_message(
    ...
    let response: EmailMessage = repository::create_message(State(state), params).await?;
    Ok(response)
}
...
pub async fn update_message(
    ...
    let response = repository::update_message(State(state), Path(id), params).await?;
    Ok(response)
}
...
pub async fn delete_message(
    ...
    repository::delete_message(State(state), Path(id)).await?;
    Ok(StatusCode::NO_CONTENT)
}
